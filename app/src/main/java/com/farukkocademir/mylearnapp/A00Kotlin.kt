...
class A00Kotlin : AppCompatActivity() {
    lateinit var textView: TextView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_a00_kotlin)

        textView = findViewById(R.id.kotlinView)
    ...
    fun inputAndOutput(){
        var inputData = sumFunc(23,23)
    }
    fun sumFunc(a:Int, b:Int) : Int
    {
        return  a + b
    }
    fun changeResult(): Int{
        return 150
    }
    fun changeViewText(){
